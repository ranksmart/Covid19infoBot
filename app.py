...
def welcome():
    ...
    <body> 
        ...
        chat-icon="https://www.freepik.com/free-vector/covid-19-poster-with-virus-icon_7538380.htm#query=Coronovirus%20icon%20png&position=26&from_view=search&track=ais" 
        allow="microphone;"
